...
func startConfiguredServer(t testing.TB, conf *http2.Server, handler http.Handler) (
	srv *httptest.Server, grpcListener net.Listener,
) {
	t.Helper()
...
func newConfiguredServer(t testing.TB, conf *http2.Server, handler http.Handler) (
	srv *httptest.Server, grpcListener net.Listener,
) {
	t.Helper()
