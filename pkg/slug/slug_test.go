...
func TestSlugMakeUserSubstituteLang(t *testing.T) {
	testCases := []struct {
		...
		{
			map[string]string{"&": "or"}, "de", "This & that", "this-or-that",
		}, // by default "&" => "und"
		{
			map[string]string{"&": "or"}, "DEU", "This & that", "this-or-that",
		}, // by default "&" => "und"
		...
		{
			map[string]string{"&": "or"}, "kk", "This & that", "this-or-that",
		}, // by default "&" => "jane"
		{
			map[string]string{"&": "or", "@": "the"}, "de", "@ This & that", "the-this-or-that",
		}, // by default "&" => "und", "@" => "an"
		{
			map[string]string{"&": "or", "@": "the"}, "sv", "@ This & that", "the-this-or-that",
		}, // by default "&" => "och", "@" => "snabel a"
	}
